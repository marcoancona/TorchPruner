...
for i in {1..3}; do python3 train.py --experiment fmnist --sparsity 0 --pruning-steps 30 --pruning-logic sv-zeros; done
for i in {1..3}; do python3 train.py --experiment fmnist --sparsity 0 --pruning-steps 30 --pruning-logic sv-nonpositive; done

# Fixed pruning ratio
for i in {1..3}; do python3 train.py --experiment fmnist --sparsity 0.15 --pruning-steps 30 --pruning-logic grad-abs-smallest; done
for i in {1..3}; do python3 train.py --experiment fmnist --sparsity 0.15 --pruning-steps 30 --pruning-logic count-smallest; done
for i in {1..3}; do python3 train.py --experiment fmnist --sparsity 0.15 --pruning-steps 30 --pruning-logic sv-abs-smallest; done
for i in {1..3}; do python3 train.py --experiment fmnist --sparsity 0.15 --pruning-steps 30 --pruning-logic random; done
